...
программы в процессе ее выполнения. В проекте реализована функция, которая принимает на вход транзакцию и возвращает
сумму транзакции в рублях. Если транзакция была в USD или EUR, происходит обращение к внешнему API для получения
текущего курса валют и конвертации суммы операции в рубли. Добавлено логирование успешных операций и ошибок.  
Реализована возможность чтения транзакций из JSON-, CSV- а так же XLSX- файлов.
...
- Логирование
- Чтение из CSV- и XLSX-файлов и возврат списка словарей с данными о финансовых транзакциях 
