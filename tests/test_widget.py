...
@pytest.mark.parametrize(
    ...
    [
        ("2023-10-05T20:52:54Z", "05.10.2023"),  # Стандартная дата
        ("1999-12-31T20:52:54Z", "31.12.1999"),  # Конец года
        ("2000-01-01T20:52:54Z", "01.01.2000"),  # Начало года
        ("0001-01-01T20:52:54Z", "01.01.0001"),  # Минимальная дата
        ("9999-12-31T20:52:54Z", "31.12.9999"),  # Максимальная дата
    ],
)
